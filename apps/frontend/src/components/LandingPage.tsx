...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 bg-[#0A2540] py-4 z-10">
        <div className="w-full max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="text-2xl font-bold text-white">ZeroBalance</div>
          <div>
            <Link to="/auth" className="text-white hover:text-[#26A69A] px-4 py-2">
              Log in
            </Link>
            <Link 
              to="/auth" 
              className="ml-4 bg-[#26A69A] hover:bg-opacity-90 text-white px-5 py-2 rounded-full font-medium"
            >
              Join Beta
            </Link>
          </div>
      ...
      {/* Hero Section */}
      <section className="w-screen bg-[#0A2540] text-white pt-32 pb-20">
        <div className="w-full max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            <span className="bg-[#26A69A] bg-opacity-20 text-[#26A69A] px-4 py-2 rounded-full text-sm font-medium mb-6 inline-block shadow-[0_0_15px_rgba(38,166,154,0.3)] animate-pulse">
              Now in Beta
            </span>
            <h1 className="text-5xl sm:text-6xl font-bold mb-4 leading-tight">
              Eliminate Debt <span className="text-[#26A69A]">Faster</span> with<br />AI-Powered Planning
            </h1>
            <p className="text-2xl font-medium text-[#26A69A] mb-8">Pay smarter. Debt faster.</p>
      ...
      <section className="w-screen py-24 bg-gradient-to-b from-[#0A2540] to-[#1E3A8A] text-white">
        <div className="w-full max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-[#102C4C] p-8 rounded-xl shadow-lg text-center transform transition-transform hover:scale-105">
      ...
      {/* Benefits Section */}
      <section className="w-screen py-24 bg-[#1E3A8A] text-white">
        <div className="w-full max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="bg-[#0A2540] p-8 rounded-xl flex items-start">
              <div className="bg-[#26A69A] h-10 w-10 rounded-full flex items-center justify-center mr-5 shrink-0 mt-1">
      ...
      {/* Pricing Section */}
      <section className="w-screen py-24 bg-[#0A2540] text-white">
        <div className="w-full max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-[#102C4C] p-8 rounded-xl">
              <div className="text-[#26A69A] font-medium mb-4">Free Tier</div>
              <h3 className="text-2xl font-bold mb-4">Basic</h3>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  <svg className="h-5 w-5 text-[#26A69A] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  Manual tracking
                </li>
              ...
              <div className="text-2xl font-bold mb-8">$0 <span className="text-sm font-normal text-gray-400">/month</span></div>
              <button className="w-full bg-[#26A69A] hover:bg-opacity-90 px-8 py-4 rounded-full font-medium transition-all">
                Get Started
              </button>
            </div>

            <div className="bg-[#102C4C] p-8 rounded-xl border-2 border-[#26A69A]">
      ...
      {/* Final CTA */}
      <section className="w-screen py-24 bg-gradient-to-b from-[#1E3A8A] to-[#0A2540] text-white">
        <div className="w-full max-w-7xl mx-auto px-6">
      ...
      {/* Feedback Section */}
      <section className="w-screen py-16 bg-[#0A2540] text-white">
        <div className="w-full max-w-7xl mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div className="bg-[#102C4C] p-6 rounded-xl">
      ...
      {/* Footer */}
      <footer className="w-screen py-12 bg-[#0A2540] border-t border-gray-800 text-white">
        <div className="w-full max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            <div className="md:col-span-2">
              <div className="text-2xl font-bold mb-4">ZeroBalance</div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-[#26A69A]">About</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[#26A69A]">Blog</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[#26A69A]">Contact</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-[#26A69A]">Privacy</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[#26A69A]">Terms</a></li>
                <li><a href="#" className="text-gray-400 hover:text-[#26A69A]">Security</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-10 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-gray-400 hover:text-[#26A69A]">
